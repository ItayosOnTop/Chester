...
A Mineflayer bot that manages your storage system, handles combat, tracks food and armor, and responds to chat commands.
...
- **Chat commands** — all features accessible through in-game chat
